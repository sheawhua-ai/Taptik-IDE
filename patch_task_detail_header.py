...
old_header = r'''<div className="workspace-sidebar-header border-b border-border-subtle bg-surface space-y-3 px-4 pt-4 pb-3">
...
new_header = '''<div className="workspace-sidebar-header border-b border-border-subtle bg-surface p-3 pr-10">
