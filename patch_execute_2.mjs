...
const startIndex = content.indexOf('const handleExecute =');
const endIndex = content.indexOf('const handleToggleProgress');
...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  content = content.substring(0, startIndex) + newHandleExecute + content.substring(endIndex);
