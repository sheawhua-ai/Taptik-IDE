...
import { 
  ...
  Filter, Layers, Orbit, Dna, ShieldHalf, Route, Workflow
} from 'lucide-react';
...
export const SkillMarket: React.FC<SkillMarketProps> = ({
  ...
  const MARKET_SKILLS = [
    ...
    { id: 'customer_seg', name: '高潜客群动态分群', category: 'data', price: '￥299/月', stats: '3w+', desc: '基于实时公域行为数据，为品牌动态标记核心决策客群。', author: 'Market Intelligence', icon: Orbit },
  ];
