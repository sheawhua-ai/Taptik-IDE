    ...
    <div className="flex flex-col h-full bg-neutral-50 p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white rounded-[32px] border border-neutral-200 p-8 shadow-sm">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                   <label className="text-[11px] font-black text-neutral-400 uppercase tracking-widest block mb-1.5">唯一 ID (UUID)</label>
                   <div className="flex items-center gap-2">
                      <p className="text-[15px] font-mono font-bold text-neutral-500">5-AD-9012-X</p>
                      <button className="text-neutral-300 hover:text-primary-500"><Copy size={14}/></button>
                   </div>
                </div>
                <div>
                   <label className="text-[11px] font-black text-neutral-400 uppercase tracking-widest block mb-1.5 focus:text-primary-500">电子邮箱</label>
                   <p className="text-[15px] font-bold text-neutral-800">test@shop.com</p>
                </div>
                <div>
                   <label className="text-[11px] font-black text-neutral-400 uppercase tracking-widest block mb-1.5 focus:text-primary-500">联系电话</label>
                   <p className="text-[15px] font-bold text-neutral-800">138****0001</p>
                </div>
                <div>
                   <label className="text-[11px] font-black text-neutral-400 uppercase tracking-widest block mb-1.5 focus:text-primary-500">所在地区</label>
                   <p className="text-[15px] font-bold text-neutral-800 flex items-center gap-1"><MapPin size={14} className="text-neutral-300"/> 广东 广州</p>
                </div>
                <div>
                   <label className="text-[11px] font-black text-neutral-400 uppercase tracking-widest block mb-1.5 focus:text-primary-500">创建时间</label>
                   <p className="text-[15px] font-bold text-neutral-800 flex items-center gap-1"><Calendar size={14} className="text-neutral-300"/> 2026-03-30 10:19:45</p>
                </div>
             </div>
          </div>
             ...
             <div className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-2xl border border-neutral-100">
                   ...
                   <div className="flex gap-2">
                      <button className="px-4 py-2 bg-neutral-900 text-white rounded-lg text-[12px] font-black">重置 Token</button>
                ...
                <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-2xl border border-neutral-100">
                   <div className="flex items-center gap-4">
                      ...
                      <div>
                         <p className="text-[14px] font-black text-neutral-800">回调 Webhook</p>
                         <p className="text-[11px] text-neutral-400 font-bold uppercase tracking-tighter">暂无配置响应地址</p>
                      </div>
                   </div>
                   <button className="px-4 py-2 border border-neutral-200 text-neutral-900 rounded-lg text-[12px] font-black hover:bg-neutral-100 text-primary-500 transition-colors">配置地址</button>
                </div>
             </div>
          </div>
        </div>
        ...
        <div className="space-y-8">
              ...
              <div className="relative z-10">
                 ...
                 <div className="space-y-4 mb-8">
                    <div className="flex justify-between items-center text-[13px]">
                       ...
                       <span className="font-black">124 天</span>
                    </div>
                 ...
                 <button className="w-full py-3 bg-white text-neutral-900 rounded-2xl text-[13px] font-black flex items-center justify-center gap-2 hover:bg-neutral-100 transition-all">
           ...
           {/* Logs or Stats */}
           <div className="bg-white rounded-[32px] border border-neutral-200 p-8 shadow-sm">
             <h3 className="text-[14px] font-black text-neutral-900 mb-6">最近操作轨迹</h3>
             <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex gap-4">
                     ...
                     <div>
                        <p className="text-[13px] font-bold text-neutral-800">{item.action}</p>
                        <p className="text-[11px] text-neutral-400 font-bold">{item.time}</p>
                     </div>
                  </div>
                ))}
             </div>
