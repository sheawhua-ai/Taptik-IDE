...
export function StrategyDraftChatCard({
  ...
  return (
    <div className="mt-3 bg-surface-1 border border-border-default rounded-xl overflow-hidden shadow-sm text-[13px] transition-all">
      ...
      <div className="p-4 bg-surface-subtle border-b border-border-default flex flex-wrap items-center justify-between gap-2">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className={`text-[13px] px-2 py-0.5 rounded font-medium border ${
              isConfirmed 
        ...
        <button
          ...
          className="px-2.5 py-1 text-[13px] bg-surface-1 hover:bg-surface-hover border border-border-default rounded-md text-text-secondary transition-colors flex items-center gap-1"
        >
      ...
      {isAllExpanded && (
        <div className="p-4 space-y-4 divide-y divide-border-subtle bg-white">
          ...
          <div className="space-y-2">
            ...
            <div className="p-3 bg-surface-subtle border border-border-subtle rounded-lg space-y-1.5 text-[13px]">
              ...
              <div className="flex items-start justify-between pt-1 border-t border-border-subtle">
                ...
                <div className="flex-1 flex flex-wrap gap-1.5">
                  {draft.promotionTarget.confirmedFacts.map((fact, idx) => (
                    <span key={idx} className="px-1.5 py-0.5 bg-white border border-border-default rounded text-[13px] text-text-secondary">
          ...
          <div className="pt-3.5 space-y-2">
            ...
            <div className="p-3 bg-surface-subtle border border-border-subtle rounded-lg space-y-2 text-[13px]">
              <div className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-emerald-700 mt-1.5 shrink-0" />
                <div>
                  <span className="text-text-tertiary block text-[13px]">主要业务目标：</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 pt-1">
                <div className="p-2 bg-white border border-border-subtle rounded text-[13px] space-y-0.5">
          ...
          <div className="pt-3.5 space-y-2">
            ...
            <div className="p-3 bg-surface-subtle border border-border-subtle rounded-lg space-y-1.5 text-[13px]">
              ...
              <div className="pt-1 text-[13px] text-text-tertiary">
          ...
          <div className="pt-3.5 space-y-2">
            ...
            <div className="space-y-2">
              {/* Brand account */}
              <div className="p-2.5 bg-surface-subtle border border-border-subtle rounded-lg flex items-center justify-between text-[13px]">
                <div>
                  <div className="flex items-center gap-2">
                    <span className="font-semibold text-text-primary">{draft.accountAndContentAssignment.brandAccounts[0]?.name || '品牌官方主号'}</span>
                    <span className="text-[13px] text-text-tertiary">({draft.accountAndContentAssignment.brandAccounts.length} 个账号)</span>
                  </div>
                ...
                <div className="text-right shrink-0 ml-3">
                  ...
                  <span className="text-[13px] text-text-tertiary block">每周 1 篇</span>
                </div>
              </div>
              ...
              <div className="p-2.5 bg-surface-subtle border border-border-subtle rounded-lg flex items-center justify-between text-[13px]">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[13px] text-text-tertiary">({draft.accountAndContentAssignment.kosAccounts.length} 个账号)</span>
                  </div>
                  <div className="text-[13px] text-text-secondary mt-0.5">
                ...
                <div className="text-right shrink-0 ml-3">
                  ...
                  <span className="text-[13px] text-text-tertiary block">按参与账号分配</span>
                </div>
              </div>
                ...
                <div className="p-2.5 bg-surface-subtle border border-border-subtle rounded-lg flex items-center justify-between text-[13px]">
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[13px] text-emerald-800 bg-emerald-50 px-1.5 py-0.2 rounded border border-emerald-200">
                        体验打卡池
                      </span>
                    </div>
                    <div className="text-[13px] text-text-secondary mt-0.5">
                  ...
                  <div className="text-right shrink-0 ml-3">
                    ...
                    <span className="text-[13px] text-text-tertiary block">招募 {draft.accountAndContentAssignment.kocParticipants.recruitmentCount} 人</span>
                  </div>
                </div>
              )}
            </div>
          ...
          <div className="pt-3.5 space-y-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-[13px]">
              <div className="p-2.5 bg-surface-subtle border border-border-subtle rounded-lg space-y-1">
                <div className="flex items-center gap-1.5 font-semibold text-text-primary text-[13px]">
              ...
              <div className="p-2.5 bg-surface-subtle border border-border-subtle rounded-lg space-y-1">
                <div className="flex items-center gap-1.5 font-semibold text-emerald-900 text-[13px]">
          ...
          <div className="pt-3.5 space-y-2">
            ...
            <div className="p-2.5 bg-surface-subtle border border-border-subtle rounded-lg text-[13px] space-y-1.5">
              ...
              <div className="flex items-center gap-2 pt-1 border-t border-border-subtle text-[13px] text-text-tertiary">
      ...
      <div className="p-4 bg-surface-subtle border-t border-border-default space-y-3">
            ...
            <div className="flex flex-wrap gap-1.5">
              {[
                ...
                <button
                  ...
                  className="px-2.5 py-1 bg-white hover:bg-surface-hover hover:border-border-strong border border-border-default rounded-md text-[13px] text-text-secondary transition-colors text-left flex items-center gap-1"
                >
        ...
        <div className="flex items-center justify-between pt-1 border-t border-border-subtle">
          ...
          <div className="flex items-center gap-2">
            ...
            {isConfirmed && (
              <div className="flex items-center gap-1.5 text-emerald-700 font-semibold text-[13px] px-3 py-1 bg-emerald-50 border border-emerald-200 rounded-lg">
