...
export const KOCQuestionnaireModal: React.FC<KOCQuestionnaireModalProps> = ({ note, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl w-full max-w-xl shadow-2xl overflow-hidden border border-neutral-200">
        <div className="p-5 border-b border-neutral-200 flex justify-between items-center bg-neutral-50">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-bold text-[16px] text-neutral-900">KOC 体验官问卷提交</h3>
              <p className="text-[12px] text-neutral-500">提交问卷即可根据【笔记包规则】即时生成专属笔记与拍摄任务</p>
            </div>
          </div>
          <button onClick={onClose} className="text-neutral-400 hover:text-neutral-600 p-1 rounded-lg hover:bg-neutral-200 transition-colors">
            <X size={18}/>
          </button>
        </div>
        ...
        {isDone ? (
          <div className="p-10 text-center space-y-3">
            ...
            <h4 className="text-[18px] font-bold text-neutral-900">问卷提交成功！</h4>
            <p className="text-[14px] text-neutral-500">已即时生成专属笔记草稿，并向您下发按任务拍摄素材需求。</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="p-6 space-y-6 max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-6">
              {/* Q1 */}
              <div>
                <label className="block text-[13px] font-bold text-neutral-900 mb-2">
                  1. 宠物当前月龄？ <span className="text-primary-500">*</span>
                </label>
              ...
              <div>
                <label className="block text-[13px] font-bold text-neutral-900 mb-2">
                  2. 换粮前最主要的困扰？(可多选) <span className="text-primary-500">*</span>
                </label>
                <div className="flex flex-wrap gap-2">
              ...
              <div>
                <label className="block text-[13px] font-bold text-neutral-900 mb-2">
                  3. 试用本产品的效果？(可多选) <span className="text-primary-500">*</span>
                </label>
                <div className="flex flex-wrap gap-2">
              ...
              <div>
                <label className="block text-[13px] font-bold text-neutral-900 mb-2">
                  4. 你会向朋友推荐吗？ <span className="text-primary-500">*</span>
                </label>
                <div className="flex flex-wrap gap-2">
                  {["会", "可能会", "不会"].map(opt => (
                    <button
