...
export const CreateMerchantModal: React.FC<CreateMerchantModalProps> = ({ isOpen, onClose, onSuccess }) => {
 ...
 <div>
 <h2 className="text-[20px] font-semibold text-slate-900 tracking-tight">新增商家</h2>
 <p className="text-[13px] text-slate-500 mt-1">创建下属商家账号并配置核心信息</p>
 </div>
 <button 
 onClick={onClose}
 ...
 className={`flex-1 py-2 text-[13px] rounded-lg transition-all ${activeTab === 'manual' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
 >
 手动填写
 </button>
 <button 
 onClick={() => setActiveTab('qr')}
 className={`flex-1 py-2 text-[13px] rounded-lg transition-all ${activeTab === 'qr' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
 >
 分享二维码
 </button>
 </div>
 ...
 <label className="text-[12px] text-slate-700 ml-1">商家名称</label>
 ...
 className="w-full h-11 pl-10 pr-4 bg-slate-50 border border-slate-200 focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 outline-none rounded-xl text-[14px] text-slate-900 placeholder:font-normal placeholder:text-slate-400 transition-all"
 />
 </div>
 </div>

 <div className="space-y-1.5">
 <label className="text-[12px] text-slate-700 ml-1">负责人用户名</label>
 <div className="relative">
 ...
 <div className="space-y-1.5">
 <label className="text-[12px] text-slate-700 ml-1">手机号码</label>
 <div className="relative">
 ...
 <div className="space-y-1.5">
 <label className="text-[12px] text-slate-700 ml-1">登录密码</label>
 <div className="relative">
 ...
 placeholder="不少于8位字符"
 className="w-full h-11 pl-10 pr-10 bg-slate-50 border border-slate-200 focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 outline-none rounded-xl text-[14px] text-slate-900 placeholder:font-normal placeholder:text-slate-400 transition-all"
 />
 <button 
 type="button"
 ...
 type="button"
 onClick={onClose}
 className="flex-1 py-3 bg-slate-100 text-slate-600 rounded-xl text-[14px] hover:bg-slate-200 transition-colors"
 >
 取消
 </button>
 <button 
 type="submit"
 className="flex-1 py-3 bg-slate-900 text-white rounded-xl text-[14px] hover:bg-primary-500 transition-colors shadow-lg shadow-slate-200"
 >
 确认新增
 </button>
 </div>
 ...
 <h3 className="text-[16px] font-semibold text-slate-900 mb-1">分享让商家扫码加入</h3>
 ...
 <button className="h-11 px-4 bg-slate-100 text-slate-600 rounded-xl text-[13px] hover:bg-slate-200 transition-colors flex items-center gap-2 shrink-0">
 <Copy size={14} /> 复制
 </button>
 </div>
 </div>
