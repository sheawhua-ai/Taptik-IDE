...
export function ReviewTaskList({
  ...
  return (
    <div className="workspace-sidebar h-full w-full bg-surface-1 flex flex-col shrink-0 z-10 overflow-hidden font-sans">
      {/* Header & Actions */}
      <div className="workspace-sidebar-header border-b border-border-default space-y-3 shrink-0 p-3">
        {/* Search */}
