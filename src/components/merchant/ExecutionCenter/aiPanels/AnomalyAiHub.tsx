    ...
    <div className="w-80 border-l border-border-default bg-surface flex flex-col shrink-0">
      ...
      <div className="p-3.5 border-b border-border-default bg-surface-subtle flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 rounded bg-rose-700 text-white flex items-center justify-center text-[11px] font-bold">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 text-[12.5px]">
        ...
        <div className="p-3.5 bg-rose-50/70 border border-rose-200/80 rounded-xl space-y-2.5">
          <div className="flex items-center justify-between">
            <div className="text-[12px] font-semibold text-rose-900 flex items-center gap-1.5">
              <ShieldAlert size={14} className="text-rose-600" />
              <span>异常根因链条诊断</span>
            </div>
            <span className="px-2 py-0.5 rounded text-[10.5px] font-medium bg-rose-100 text-rose-800">
              {task.isBlocked ? '流程阻塞中' : '需人工介入'}
            </span>
          </div>

          <div className="text-[11.5px] text-rose-950 space-y-1 leading-relaxed">
          ...
          <div className="pt-2 border-t border-rose-200/60 text-[11px] text-rose-800 flex items-start gap-1">
        ...
        <div className="space-y-2.5">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10.5px] text-text-tertiary">3 套可选策略</span>
          </div>
          ...
          >
            ...
            <button
              ...
              className="w-full py-1.5 bg-neutral-900 hover:bg-neutral-800 text-white rounded-lg text-[11.5px] font-semibold transition-colors flex items-center justify-center gap-1 shadow-sm"
            >
              <User size={12} />
              <span>立即唤起改派</span>
            </button>
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <span className="px-2 py-0.5 rounded text-[10.5px] font-medium bg-surface-subtle text-text-secondary border border-border-default">
                免拍摄
              </span>
            </div>
            <div className="text-[11.5px] text-text-secondary leading-relaxed">
            ...
            <button
              ...
              className="w-full py-1.5 bg-surface-subtle hover:bg-surface-hover text-text-primary border border-border-default rounded-lg text-[11.5px] font-medium transition-colors flex items-center justify-center gap-1"
            >
              <Check size={12} />
              <span>采纳素材库资产</span>
            </button>
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <span className="px-2 py-0.5 rounded text-[10.5px] font-medium bg-amber-50 text-amber-900 border border-amber-200">
                限时通牒
              </span>
            </div>
            <div className="text-[11.5px] text-text-secondary leading-relaxed">
        ...
        <div className="space-y-2 pt-2 border-t border-border-subtle">
          ...
          <button
            ...
            className="w-full text-left p-2.5 bg-surface hover:bg-surface-hover border border-border-default rounded-lg text-[11.5px] transition-colors flex items-center justify-between group"
          >
        ...
        <div className="p-3 bg-surface-subtle border border-border-subtle rounded-xl space-y-1.5">
          <div className="text-[11.5px] font-semibold text-text-primary flex items-center gap-1">
