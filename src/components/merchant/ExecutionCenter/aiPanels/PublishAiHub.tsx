    ...
    <div className="w-80 border-l border-border-default bg-surface flex flex-col shrink-0">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 text-[12.5px]">
        ...
        <div className="p-3.5 bg-surface-subtle border border-border-subtle rounded-xl space-y-3">
          ...
          <div className="p-2 bg-emerald-50/80 rounded-lg border border-emerald-200/80 text-[11px] text-emerald-900 leading-relaxed flex items-start gap-1.5">
        ...
        <div className="p-3.5 bg-surface rounded-xl border border-border-default space-y-2.5 shadow-sm">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10.5px] text-text-tertiary">黄金发布期</span>
          </div>
        ...
        <div className="space-y-2.5">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10.5px] text-text-tertiary">一键复制带节奏</span>
          </div>
          ...
          <div className="flex gap-1 overflow-x-auto pb-1">
            {commentTemplates.map((t, idx) => (
              <button
                ...
                className={`px-2.5 py-1 text-[11px] rounded-md transition-colors whitespace-nowrap shrink-0 ${
            ...
            <div className="p-3 bg-surface border border-border-default rounded-xl space-y-2.5 shadow-sm animate-in fade-in duration-150">
              ...
              <div className="flex items-center justify-end gap-2 pt-1 border-t border-border-subtle">
                <button
                  ...
                  className="px-3 py-1.5 bg-neutral-900 hover:bg-neutral-800 text-white rounded-lg text-[11.5px] font-semibold transition-colors flex items-center gap-1.5 shadow-sm"
                >
                  <Copy size={12} />
                  <span>复制首评文案</span>
                </button>
