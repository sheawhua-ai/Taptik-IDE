...
export const INITIAL_EXECUTION_TASKS: ExecutionTask[] = [
  ...
  },
  {
    ...
    taskFormat: '自有指定',
    assignee: { name: '新媒体-小美', assignedTime: '1天前 (09-03)', wechat: 'xiaomei_work' },
  ...
  },
  {
    ...
    taskFormat: '自有指定',
    assignee: { name: '运营-张三', assignedTime: '2天前 (09-02)', wechat: 'zhangsan_op' },
    stalledDurationText: '已超时 1 天',
    projectId: 'p2',
  ...
  },
  {
    ...
    taskFormat: '任务包',
    assignee: { name: '静安店李店长', claimTime: '08-28', wechat: 'store_lee_jingan' },
    stalledDurationText: '领取后 3 天未发',
  ...
  },
  {
    ...
    taskFormat: '笔记包',
    assignee: { name: '环球港店导购-晓红', claimTime: '1天前 (09-03)', wechat: 'guide_xiaohong' },
...
2026备婚的姐妹如果有档期疑问，可以看我主页或者直接私信交流！`,
  ...
  },
  {
    ...
    nextStepAfterAction: '重新指派给静安店员工号或由操盘手代发后，任务即可继续推进。',
    timelineEvents: [
