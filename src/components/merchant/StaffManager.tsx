...
export const StaffManager: React.FC = () => {
 ...
 type="text" 
 placeholder="搜索名称或邮箱..." 
 className="pl-10 pr-4 py-2 bg-page-bg border border-border-default rounded-xl text-[13px] focus:outline-none focus:border-primary-500 w-64"
 />
 </div>
 ...
 <tr key={staff.id} className="hover:bg-page-bg transition-colors">
 <td className="px-8 py-5">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 rounded-full bg-hover-bg flex items-center justify-center text-text-tertiary ">
 {staff.name[0]}
 </div>
 <span className="text-[14px] text-text-main">{staff.name}</span>
 </div>
 </td>
 <td className="px-8 py-5">
 ...
 <span className="text-[13px] text-text-secondary">在线</span>
 </div>
 </td>
 <td className="px-8 py-5 text-[13px] text-text-tertiary">{staff.lastActive}</td>
 <td className="px-8 py-5 text-right">
 <div className="flex items-center justify-end gap-2">
 <button className="p-2 text-text-tertiary hover:text-text-main"><Key size={18}/></button>
 <button className="p-2 text-text-tertiary hover:text-text-main"><Settings size={18}/></button>
 <button className="p-2 text-text-tertiary hover:text-brand-logo"><Trash2 size={18}/></button>
 </div>
 </td>
 </tr>
 ))}
