        ...
        <div className="p-6 border-b border-neutral-100 flex items-center justify-between">
           <div className="relative">
              ...
              <input 
                type="text" 
                placeholder="搜索名称或邮箱..." 
                className="pl-10 pr-4 py-2 bg-neutral-50 border border-neutral-200 rounded-xl text-[13px] font-bold focus:outline-none focus:border-primary-500 w-64"
              />
           </div>
           <div className="flex items-center gap-2">
              <span className="text-[12px] font-bold text-neutral-400">过滤角色:</span>
              <select className="bg-neutral-50 border border-neutral-200 text-[12px] font-black rounded-lg px-2 py-1 outline-none">
                 <option>全部</option>
                 <option>管理员</option>
                 <option>运营</option>
              </select>
                ...
                <tr key={staff.id} className="hover:bg-neutral-50/50 transition-colors">
                  <td className="px-8 py-5">
                    <div className="flex items-center gap-3">
                       <div className="w-10 h-10 rounded-full bg-neutral-100 flex items-center justify-center text-neutral-500 font-black">
                         {staff.name[0]}
                       </div>
                       <span className="text-[14px] font-black text-neutral-800">{staff.name}</span>
                    </div>
                  </td>
                  <td className="px-8 py-5">
                    <div className="flex flex-col">
                       <span className="text-[13px] font-bold text-neutral-600 flex items-center gap-1.5"><Mail size={12}/> {staff.email}</span>
                       <span className="text-[11px] font-bold text-neutral-400 flex items-center gap-1.5 mt-0.5"><Phone size={12}/> {staff.phone}</span>
                    </div>
                  </td>
                  <td className="px-8 py-5">
                    <div className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-[11px] font-black uppercase tracking-tight ${
                  ...
                  <td className="px-8 py-5 text-[13px] font-bold text-neutral-400">{staff.lastActive}</td>
