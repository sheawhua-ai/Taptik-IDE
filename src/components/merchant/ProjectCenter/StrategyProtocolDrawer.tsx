...
import { X, CheckCircle2, FileText, ShieldAlert, Target, Users, Calendar, Eye, Activity } from "lucide-react";
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div className="space-y-3 text-[13px]">
              ...
              <div>
                ...
                <div className="space-y-2 text-[13px]">
                  ...
                  <div className="flex items-center justify-between p-2.5 bg-surface-subtle rounded-lg border border-border-default">
                    <span className="font-normal text-text-secondary">消费者 KOC (笔记包)</span>
                    <span className="font-medium text-text-main">10-13 篇 · 真实测评体验与场景种草</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-surface-1 rounded-xl p-5 border border-border-default space-y-4">
            ...
            <div className="space-y-2.5 text-[13px]">
              ...
              <div className="p-3 bg-surface-subtle rounded-lg border border-border-default">
                <div className="font-medium text-text-main mb-1">执行控制要求</div>
                <div className="text-text-secondary leading-relaxed">
                  根据问卷动态生成个性化笔记；自有账号经定向下发，发布后由系统自动识别笔记ID进入观察。
                </div>
              </div>
            </div>
          </div>
