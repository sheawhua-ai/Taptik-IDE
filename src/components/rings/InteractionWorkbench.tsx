           ...
           <div className="p-4 border border-rose-100 bg-rose-50 rounded-xl">
             ...
             {!factChecked ? (
                <>
                  ...
                  <div className="flex gap-2">
                    <button className="px-3 py-1.5 bg-white border border-rose-200 text-rose-700 rounded-lg text-[12px] font-bold hover:bg-rose-100">查看相关资料</button>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-[320px] bg-white border-r border-neutral-200 overflow-y-auto p-4 space-y-4">
          ...
          <div>
            ...
            <div className="p-3 bg-white rounded-xl border border-neutral-200 cursor-pointer hover:bg-neutral-50 transition-colors">
        ...
        <div className="w-[360px] bg-white flex flex-col shrink-0">
          ...
          <div className="flex-1 p-5 overflow-y-auto space-y-5">
             <div>
               ...
               <div className="text-[13px] font-bold text-neutral-800">产品适配度咨询（颗粒大小对大型犬的适用性）</div>
             </div>
             
             <div>
               <div className="text-[12px] font-bold text-neutral-500 mb-2">建议回复身份</div>
               <div className="text-[13px] font-bold text-primary-700 bg-primary-50 px-3 py-1.5 rounded-lg inline-block border border-primary-100">官方旗舰店 (品牌号)</div>
             </div>
             
             <div>
               <div className="text-[12px] font-bold text-neutral-500 mb-2">回复草稿</div>
               <textarea 
                  className="w-full bg-neutral-50 border border-neutral-200 rounded-xl p-3 text-[13px] text-neutral-800 min-h-[120px] resize-none outline-none focus:border-primary-400 focus:ring-1 focus:ring-primary-400 transition-all"
          ...
          <div className="p-4 border-t border-neutral-200 bg-white shrink-0 space-y-2">
             <button className="w-full py-2.5 rounded-xl text-[13px] font-bold bg-neutral-900 text-white flex items-center justify-center gap-2 hover:bg-neutral-800 transition-colors">
             ...
             <div className="grid grid-cols-2 gap-2 mt-2">
               ...
               <button className="py-2 text-[12px] font-medium text-neutral-600 border border-neutral-200 rounded-xl hover:bg-neutral-50 transition-colors">稍后处理</button>
             </div>
             <button className="w-full py-2 text-[12px] font-medium text-neutral-600 border border-neutral-200 rounded-xl hover:bg-neutral-50 transition-colors">
               通知账号主处理
             </button>
          </div>
        </div>
...
function InterceptTab() {
  ...
  return (
    <div className="h-full flex overflow-hidden relative">
      {/* Left */}
      <div className="w-[320px] bg-white border-r border-neutral-200 overflow-y-auto p-4 space-y-4 custom-scrollbar">
         <div>
            ...
            <div className="p-3 bg-neutral-50 rounded-xl border border-primary-200 cursor-pointer shadow-sm mb-2">
              <div className="flex justify-between mb-1">
                 ...
                 <span className="text-[10px] text-rose-600 bg-rose-50 px-1.5 py-0.5 rounded font-bold">高需求</span>
              </div>
      ...
      <div className="w-[360px] bg-white flex flex-col shrink-0">
          ...
          <div className="flex-1 p-5 overflow-y-auto space-y-5 custom-scrollbar">
             ...
             <div>
               ...
               <select className="w-full border border-neutral-200 rounded-xl px-3 py-2.5 text-[13px] font-medium bg-neutral-50 outline-none hover:border-neutral-300 transition-colors cursor-pointer">
             ...
             <div>
               <div className="text-[12px] font-bold text-neutral-500 mb-2">回复草稿</div>
               <textarea 
                  className="w-full bg-neutral-50 border border-neutral-200 rounded-xl p-3 text-[13px] text-neutral-800 min-h-[100px] resize-none outline-none focus:border-primary-400 focus:ring-1 focus:ring-primary-400 transition-all"
                  defaultValue={"同肠胃不好的狗子！可以看看XX（咱们品牌），性价比很高，里面加了益生菌，我家换了这个之后就不软便了，可以先弄点试吃装试试。"}
               />
               <div className="bg-rose-50 p-2 rounded-lg text-[10px] text-rose-600 mt-2 flex items-start gap-1.5 leading-relaxed">
          ...
          <div className="p-4 border-t border-neutral-200 bg-white shrink-0 space-y-2">
             ...
             <button 
               ...
               className="w-full py-2.5 rounded-xl text-[13px] font-bold bg-primary-50 text-primary-600 flex items-center justify-center gap-2 hover:bg-primary-100 transition-colors border border-primary-100"
             >
               <User size={16} /> 派给员工处理
             </button>
             <div className="grid grid-cols-2 gap-2 mt-1">
               <button className="py-2 text-[12px] font-medium text-neutral-600 border border-neutral-200 bg-neutral-50 rounded-xl hover:bg-neutral-100 transition-colors">标记已回复</button>
               <button className="py-2 text-[12px] font-medium text-neutral-600 border border-neutral-200 bg-neutral-50 rounded-xl hover:bg-neutral-100 transition-colors">不适合承接</button>
             </div>
             <button className="w-full py-2 text-[12px] font-medium text-primary-600 hover:text-primary-700 transition-colors">
               转为内容机会
             </button>
          </div>
      </div>
      ...
      <AnimatePresence>
        {showAssignPopup && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="absolute inset-0 bg-neutral-900/20 backdrop-blur-sm z-50 flex items-center justify-center"
          >
            <motion.div
              initial={{ scale: 0.95 }}
              animate={{ scale: 1 }}
              exit={{ scale: 0.95 }}
              className="bg-white rounded-2xl shadow-2xl p-6 w-[360px] border border-neutral-200"
            >
              <div className="flex justify-between items-center mb-5">
                <h3 className="text-[16px] font-bold text-neutral-900">派发承接任务</h3>
                <button onClick={() => setShowAssignPopup(false)} className="text-neutral-400 hover:text-neutral-600"><X size={18}/></button>
              </div>
              <div className="space-y-4 mb-6">
                <div>
                  <label className="block text-[12px] font-bold text-neutral-700 mb-1.5">选择执行员工</label>
                  <select className="w-full border border-neutral-200 rounded-xl px-3 py-2.5 text-[13px] outline-none hover:border-neutral-300">
                    <option>张三 (客服组)</option>
                    <option>李四 (运营组)</option>
                  </select>
                </div>
                <div>
                  <label className="block text-[12px] font-bold text-neutral-700 mb-1.5">指定承接账号</label>
                  <select className="w-full border border-neutral-200 rounded-xl px-3 py-2.5 text-[13px] outline-none hover:border-neutral-300">
              ...
              <div className="bg-neutral-50 p-3 rounded-xl border border-neutral-100 mb-6">
                <div className="text-[11px] text-neutral-500 mb-2">生成任务链接</div>
                <div className="flex gap-2">
                  <div className="flex-1 bg-white border border-neutral-200 rounded-lg px-3 py-2 text-[12px] text-neutral-400 truncate">
                    https://ais.studio/task/x8f2a...
                  </div>
                  <button className="px-3 py-2 bg-neutral-900 text-white rounded-lg text-[12px] font-bold hover:bg-neutral-800 shrink-0">
                    复制
                  </button>
                </div>
              </div>
              <button 
                ...
                className="w-full py-2.5 bg-neutral-100 text-neutral-700 rounded-xl text-[13px] font-bold hover:bg-neutral-200 transition-colors"
              >
                完成
              </button>
            </motion.div>
  ...
  return (
    <div className="h-full bg-[#fcfcfc] overflow-y-auto p-8 custom-scrollbar">
       <div className="max-w-4xl mx-auto">
          {/* Header */}
          <div className="bg-white p-6 rounded-2xl border border-neutral-200 shadow-sm mb-6 flex items-start justify-between">
             <div>
                <h2 className="text-[18px] font-bold text-neutral-900 mb-2 flex items-center gap-2">
             ...
             <div className="text-[11px] font-medium text-neutral-500 bg-neutral-100 border border-neutral-200 px-3 py-1.5 rounded-lg flex items-center gap-1.5">
          ...
          <div className="grid grid-cols-2 gap-6">
             ...
             <div className="space-y-6">
                <div className="bg-white p-6 rounded-2xl border border-neutral-200 shadow-sm">
                   <h3 className="text-[15px] font-bold text-neutral-900 mb-5 flex items-center gap-2">高频痛点 & 购买阻力</h3>
                   <div className="space-y-4">
                      <div>
                        <div className="flex items-center justify-between mb-1.5">
                          <span className="text-[13px] font-bold text-rose-700">价格过高/双十一优惠力度小</span>
                          <span className="text-[12px] font-medium text-neutral-500">42%</span>
                        </div>
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-1.5">
                          ...
                          <span className="text-[12px] font-medium text-neutral-500">28%</span>
                        </div>
                        <div className="w-full bg-neutral-100 h-1.5 rounded-full overflow-hidden"><div className="bg-rose-500 h-full w-[28%]"></div></div>
                      </div>
                   </div>
                   <button className="mt-5 text-[12px] text-primary-600 font-bold flex items-center gap-1 hover:text-primary-700 transition-colors">
                     <Eye size={14}/> 查看这 189 条评论样本
                   </button>
                </div>
                
                <div className="bg-white p-6 rounded-2xl border border-neutral-200 shadow-sm">
                   <h3 className="text-[15px] font-bold text-neutral-900 mb-4 flex items-center gap-2">新需求信号</h3>
                   ...
                   <button className="text-[12px] text-primary-600 font-bold flex items-center gap-1 hover:text-primary-700 transition-colors">
             ...
             <div className="space-y-6">
                <div className="bg-white p-6 rounded-2xl border border-neutral-200 shadow-sm">
                   <h3 className="text-[15px] font-bold text-neutral-900 mb-4 flex items-center gap-2">典型用户原话</h3>
                   <div className="space-y-3">
                      <div className="p-4 bg-neutral-50 rounded-xl border border-neutral-100 text-[13px] text-neutral-700 italic leading-relaxed">
                ...
                <div className="bg-white p-6 rounded-2xl border border-neutral-200 shadow-sm">
                   <h3 className="text-[15px] font-bold text-neutral-900 mb-4 flex items-center gap-2">操作建议</h3>
                   <div className="space-y-3">
                     <button className="w-full py-2.5 px-4 text-left border border-neutral-200 rounded-xl text-[13px] font-bold text-neutral-700 hover:bg-neutral-50 hover:border-neutral-300 transition-all flex justify-between items-center group">
                       存为待确认商家记忆
...
function RiskTab() {
  return (
    <div className="h-full flex overflow-hidden">
      {/* Left */}
      <div className="w-[320px] bg-white border-r border-neutral-200 flex flex-col shrink-0 overflow-y-auto p-4 space-y-4 custom-scrollbar">
        <div className="p-3 bg-rose-50 rounded-xl border border-rose-200 cursor-pointer shadow-sm relative overflow-hidden">
          ...
          <div className="text-[12px] text-neutral-600 line-clamp-2 mb-3">吃了你们家新批次的粮，狗狗疯狂抓挠，起红疹了，必须给我个说法！！</div>
        ...
        <div className="p-6 flex-1 overflow-y-auto custom-scrollbar">
           ...
           <div className="bg-white p-5 rounded-2xl border border-neutral-200 shadow-sm mb-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                   <div className="text-[14px] font-bold text-neutral-900 mb-2">用户：暴躁的萨摩耶</div>
                   <div className="text-[13px] text-neutral-800 bg-rose-50 p-4 rounded-xl border border-rose-100 leading-relaxed">
           ...
           <div className="grid grid-cols-2 gap-4">
              <div className="bg-white p-5 rounded-xl border border-neutral-200 shadow-sm">
                <div className="text-[12px] font-bold text-neutral-500 mb-1.5 flex items-center gap-1.5"><FileText size={14}/> 关联笔记 / 账号</div>
                <div className="text-[13px] font-bold text-neutral-900">《双十一囤粮必看》 / 官方旗舰店</div>
              </div>
              <div className="bg-white p-5 rounded-xl border border-neutral-200 shadow-sm">
                <div className="text-[12px] font-bold text-neutral-500 mb-1.5 flex items-center gap-1.5"><Eye size={14}/> 扩散情况</div>
         ...
         <div className="flex-1 p-6 overflow-y-auto space-y-8 relative custom-scrollbar">
            ...
            <div className="relative z-10 flex gap-4">
               ...
               <div className="flex-1">
                  ...
                  <div className="bg-neutral-50 p-4 rounded-xl border border-neutral-200 mb-3">
                     <div className="flex flex-wrap gap-2 mb-3">
                       <span className="text-[11px] bg-emerald-100 text-emerald-700 px-2 py-1 rounded-md font-bold">已确认事实: 售后渠道畅通</span>
                       <span className="text-[11px] bg-neutral-200 text-neutral-600 px-2 py-1 rounded-md font-bold">未知事实: 致敏原因</span>
                       <span className="text-[11px] bg-rose-100 text-rose-700 px-2 py-1 rounded-md font-bold">禁止承诺: 退赔金额</span>
                     </div>
                     <div className="text-[13px] text-neutral-800 leading-relaxed bg-white p-3 border border-neutral-100 rounded-lg">
            ...
            {/* Stage 2 */}
            <div className="relative z-10 flex gap-4">
               <div className="w-8 h-8 rounded-full bg-primary-100 text-primary-600 flex items-center justify-center font-bold text-[13px] shrink-0 border-2 border-white shadow-sm">2</div>
               <div className="flex-1">
                  ...
                  <div className="text-[11px] text-rose-600 mb-3 font-bold bg-rose-50 p-2 rounded-lg flex items-start gap-1.5 leading-relaxed border border-rose-100">
                    <AlertTriangle size={14} className="shrink-0 mt-0.5"/> 需在私信中索要隐私信息，公开评论区禁止。
                  </div>
                  <button className="w-full py-2.5 bg-white border border-neutral-200 text-neutral-700 rounded-xl text-[13px] font-bold hover:bg-neutral-50 transition-colors shadow-sm">
                    生成私信草稿并通知账号主
                  </button>
               </div>
            </div>
...
function RuleCard({ title, current, suggestion }: { title: string, current: string, suggestion?: string }) {
  return (
    <div className="bg-white border border-neutral-200 rounded-2xl p-5 shadow-sm">
      ...
      <div className="bg-neutral-50 p-4 rounded-xl border border-neutral-100 mb-4 text-[13px] text-neutral-700 leading-relaxed">
        {current}
      </div>
      {suggestion && (
        <div className="text-[12px] text-primary-600 bg-primary-50 p-3 rounded-xl mb-4 flex items-start gap-1.5 border border-primary-100/50">
      ...
      <div className="relative mt-2">
        <input 
          ...
          className="w-full border border-neutral-200 rounded-xl pl-4 pr-10 py-2.5 text-[13px] outline-none focus:border-primary-400 focus:ring-1 focus:ring-primary-400 transition-all bg-white"
        />
        <button className="absolute right-2 top-1/2 -translate-y-1/2 text-primary-600 hover:text-primary-700 p-1.5 rounded-lg hover:bg-primary-50 transition-colors">
          <Send size={14} />
        </button>
      </div>
    </div>
