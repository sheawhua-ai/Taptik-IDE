 ...
 <div className="flex flex-col h-full w-full bg-white overflow-hidden">
    <div className="h-20 border-b border-neutral-100 flex items-center justify-between px-8 bg-white shrink-0 z-10 w-full mb-0">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-[17px] font-semibold text-neutral-900 tracking-tight">舆情预警与工单</h2>
          <p className="text-[11px] text-neutral-400 mt-0.5">自动捕捉高意向客资与公关风险，生成统一下发工单</p>
        </div>
      </div>
    </div>
