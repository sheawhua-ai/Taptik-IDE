...
export const Metrics: React.FC<{ hasData?: boolean }> = ({ hasData = true }) => {
 ...
 className={`w-full flex items-center gap-3 px-4 py-3 rounded-2xl text-[13px] transition-all ${dataSubNav === btn.id ? 'bg-white text-primary-500 shadow-sm border border-neutral-100' : 'text-neutral-500 hover:bg-neutral-100'}`}
 >
