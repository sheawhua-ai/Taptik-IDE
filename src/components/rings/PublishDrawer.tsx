      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar bg-neutral-50/30">
          ...
          <div className="bg-white border border-neutral-200 rounded-xl shadow-sm overflow-hidden">
            <div className="p-4 border-b border-neutral-100 flex items-center justify-between bg-primary-50/30">
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-primary-500" />
                <h4 className="font-bold text-[14px] text-neutral-900">官方号发布包</h4>
              </div>
              <span className="text-[12px] font-bold text-primary-600 bg-primary-50 px-2 py-0.5 rounded">3 篇，账号已确认，可排期</span>
            </div>
            <div className="p-4 flex flex-col gap-3">
              ...
              <div className="flex gap-2 mt-1">
                ...
                <button className="flex-1 py-2 text-[12px] font-bold text-primary-700 bg-primary-50 hover:bg-primary-100 rounded-lg flex items-center justify-center gap-1.5 transition-colors">
          ...
          <div className="bg-white border border-neutral-200 rounded-xl shadow-sm overflow-hidden">
            <div className="p-4 border-b border-neutral-100 flex items-center justify-between bg-primary-50/30">
              ...
              <span className="text-[12px] font-bold text-primary-600 bg-primary-50 px-2 py-0.5 rounded">4 篇，2 篇待员工确认</span>
            </div>
            <div className="p-4 flex flex-col gap-3">
              <div className="flex items-center justify-between text-[13px]">
              ...
              <div className="flex gap-2 mt-1">
                <button className="flex-1 py-2 text-[12px] font-bold text-primary-700 bg-primary-50 hover:bg-primary-100 rounded-lg flex items-center justify-center gap-1.5 transition-colors border border-primary-100">
          ...
          <div className="bg-white border border-neutral-200 rounded-xl shadow-sm overflow-hidden">
            <div className="p-4 border-b border-neutral-100 flex items-center justify-between bg-primary-50/30">
              ...
              <span className="text-[12px] font-bold text-primary-600 bg-primary-50 px-2 py-0.5 rounded">5 个扫码名额</span>
            </div>
            <div className="p-4 flex flex-col gap-3">
              <div className="flex items-center justify-between text-[13px]">
          ...
          {/* 泛素人 KOC */}
          <div className="bg-white border border-neutral-200 rounded-xl shadow-sm overflow-hidden">
            <div className="p-4 border-b border-neutral-100 flex items-center justify-between bg-neutral-100/30">
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-neutral-900" />
                <h4 className="font-bold text-[14px] text-neutral-900">泛素人分发 (人工审核)</h4>
              </div>
              <span className="text-[12px] font-bold text-primary-600 bg-primary-50 px-2 py-0.5 rounded">8 篇，待预设人设</span>
            </div>
            <div className="p-4 flex flex-col gap-3">
              <div className="flex items-center justify-between text-[13px]">
              ...
              <div className="flex gap-2 mt-1">
                <button className="flex-1 py-2 text-[12px] font-bold text-neutral-900 bg-neutral-100 hover:bg-neutral-200 rounded-lg flex items-center justify-center gap-1.5 transition-colors border border-neutral-200">
