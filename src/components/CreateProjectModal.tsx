...
export const CreateProjectModal: React.FC<CreateProjectModalProps> = ({ isOpen, onClose }) => {
 ...
 <h2 className="text-[20px] font-semibold text-slate-800 tracking-tight">新建项目</h2>
 <button 
 onClick={onClose}
 ...
 <div>
 <div className="text-[16px] text-slate-800 mb-1">从头开始</div>
 ...
 <div>
 <div className="text-[16px] text-slate-800 mb-1">使用现有文件夹</div>
