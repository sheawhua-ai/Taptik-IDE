...
export const FinancePanelModal: React.FC<FinancePanelModalProps> = ({ 
 ...
 <div>
 <div className="text-[14px] text-slate-400 mb-2 flex items-center gap-2">
 ...
 <span className="text-[16px] text-slate-400 mb-2 font-mono">≈ {formatRMB(305.60)}</span>
 </div>
 </div>
 <button className="px-6 py-3 bg-white text-slate-900 rounded-xl text-[14px] hover:bg-slate-100 transition-colors shadow-sm">
 兑换码充值
 </button>
 </div>
 </div>
 ...
 className={`px-6 py-2 text-[13px] rounded-lg transition-all ${activeTab === 'recharge' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
 >
 充值额度
 </button>
 <button 
 onClick={() => setActiveTab('history')}
 className={`px-6 py-2 text-[13px] rounded-lg transition-all ${activeTab === 'history' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
 >
 消费流水
 </button>
 </div>
 ...
 {plan.recommend && (
 <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-3 py-1 bg-primary-500 text-white text-[11px] rounded-full shadow-sm">
 推荐套餐
 </div>
 )}
 <div className="text-[24px] text-slate-900 mb-1 flex items-center justify-center gap-1.5">
 ...
 <button className={`w-full py-2.5 rounded-xl text-[14px] transition-colors ${plan.recommend ? 'bg-primary-500 text-white hover:bg-primary-600' : 'bg-slate-100 text-slate-700 hover:bg-slate-200'}`}>
 ...
 <div>
 <div className="text-[14px] text-slate-900">{sh.title}</div>
 <div className="text-[12px] text-slate-500">{sh.time}</div>
 </div>
 </div>
 <div className="text-right">
 <div className={`text-[16px] font-mono ${sh.amount > 0 ? 'text-green-600' : 'text-slate-900'}`}>
 ...
 className="px-8 py-3 bg-white text-[#CC1E4A] rounded-xl text-[14px] hover:bg-slate-50 transition-colors shadow-sm"
 >
 申请提现
 </button>
 </div>
 ...
 className={`px-6 py-2 text-[13px] rounded-lg transition-all ${activeProviderTab === 'dashboard' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
 >
 分账明细
 </button>
 <button 
 onClick={() => setActiveProviderTab('withdraw')}
 className={`px-6 py-2 text-[13px] rounded-lg transition-all ${activeProviderTab === 'withdraw' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
 >
 提现记录
 </button>
 </div>
 ...
 <div className="text-right text-[16px] font-mono text-slate-900">
 +{formatRMB(sh.amount)}
 </div>
 </div>
 ))}
 ...
 <div>
 <div className="text-[14px] text-slate-900 mb-1">提现至对公账户</div>
 ...
 <div className="space-y-3">
 <div className="text-[14px] text-slate-900 px-1">历史提现</div>
 {[
 ...
 className={`px-4 h-full text-[13px] rounded-lg transition-all ${providerTopTab === 'income' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
 >
 💰 收益中心
 </button>
 <button 
 onClick={() => setProviderTopTab('credits')}
 className={`px-4 h-full text-[13px] rounded-lg transition-all ${providerTopTab === 'credits' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
 >
 ✨ 消耗积分 
 </button>
 </div>
