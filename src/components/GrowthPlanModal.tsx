            ...
            <div className="fixed inset-0 z-[1100] flex items-center justify-center p-4">
               ...
               >
                  <div className="flex items-center justify-between px-8 pt-8 pb-4 border-b border-neutral-100">
                     <div>
                        <h2 className="text-[20px] font-black text-slate-900 tracking-tight">成长计划分享</h2>
                        <p className="text-[13px] font-bold text-slate-500 mt-1">分享专属二维码，获得更多权益</p>
                     </div>
                     <button 
                        onClick={onClose}
                  ...
                  <div className="px-8 pt-4 pb-2">
                     <div className="flex p-1 bg-slate-100 rounded-xl">
                        <button 
                           ...
                           className={`flex-1 py-2 text-[13px] font-black rounded-lg transition-all ${activeTab === 'merchant' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
                        >
                           分享让更多商家加入成为下属
                        </button>
                        <button 
                           onClick={() => setActiveTab('provider')}
                           className={`flex-1 py-2 text-[13px] font-black rounded-lg transition-all ${activeTab === 'provider' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
                        >
                           分享企业或个人成为服务商
                        </button>
                     </div>
                  ...
                  <div className="p-8 flex flex-col items-center">
                     {activeTab === 'merchant' ? (
                        <>
                           <div className="text-center mb-6">
                              <h3 className="text-[16px] font-black text-slate-900 mb-1">邀请更多商家加入成为下属</h3>
                        ...
                        <>
                           <div className="text-center mb-6">
                              <h3 className="text-[16px] font-black text-slate-900 mb-1">邀请企业或个人成为服务商</h3>
                     ...
                     <div className="w-full mt-8 space-y-3">
                        ...
                        <button className="w-full py-3 bg-slate-900 text-white rounded-xl text-[14px] font-black hover:bg-primary-500 transition-colors shadow-lg shadow-slate-200 flex items-center justify-center gap-2">
                           <Share2 size={16} /> 立即分享
                        </button>
                     </div>
                  </div>
