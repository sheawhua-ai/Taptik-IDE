...
export const ServiceManagement: React.FC<ServiceManagementProps> = ({ 
 ...
 <div className="w-10 h-10 bg-brand-light rounded-xl flex items-center justify-center text-brand-logo text-xs">
 ...
 <span className="px-1.5 py-0.5 bg-hover-bg text-text-tertiary text-[10px] rounded uppercase">uuid: {selectedMerchant.id}</span>
 </div>
 <p className="text-[11px] text-text-tertiary uppercase tracking-wider mt-0.5">正在管理该商家数据与资产</p>
 </div>
 </div>
 </div>
 ...
 <span className="px-2 py-0.5 bg-hover-bg text-text-main text-[10px] rounded-lg">绑定分销 ID</span>
 </div>
 ...
 <button className="w-full mt-4 py-2 text-[12px] text-brand-logo hover:bg-brand-light rounded-lg transition-colors border border-primary-50 flex items-center justify-center gap-2">
 <Download size={14} /> 保存商家码
 </button>
 </div>
 <div className="flex-1 w-full space-y-6">
 <div>
 <label className="text-[11px] text-text-tertiary uppercase tracking-widest block mb-1.5">入驻短链</label>
 ...
 <div className="px-2 py-0.5 bg-hover-bg rounded-lg text-[11px] text-text-tertiary">活跃使用 / 活跃商家</div>
 </div>
 <div className="flex items-center gap-3">
 ...
 <thead>
 <tr className="bg-page-bg text-[10px] text-text-tertiary uppercase tracking-widest border-b border-border-default">
 ...
 <td className="px-8 py-5 font-mono text-[11px] text-text-tertiary">#{m.id}</td>
 ...
 <span className="text-[11px] text-text-tertiary ">{m.phone}</span>
 </div>
 </td>
 <td className="px-8 py-5">
 <span className="px-2.5 py-1 bg-hover-bg text-text-main text-[10px] rounded-lg border border-success-100">活跃商户</span>
 </td>
 <td className="px-8 py-5">
 <div className="flex items-center gap-4">
 <div className="text-center">
 <p className="text-[10px] text-text-tertiary uppercase">当前余额</p>
 <p className="text-[13px] text-text-main">5,420</p>
 </div>
 <div className="w-px h-6 bg-hover-bg" />
 <div className="text-center">
 <p className="text-[10px] text-text-tertiary uppercase">爆文数</p>
 ...
 <p className="text-[11px] text-text-tertiary uppercase mb-1">团队成员</p>
 <p className="text-2xl text-text-main">18 <span className="text-[12px] text-neutral-300">/ 无限制</span></p>
 </div>
 <div className="bg-surface-1 p-6 rounded-2xl border border-border-default">
 <p className="text-[11px] text-text-tertiary uppercase mb-1">飞书账号映射</p>
 <p className="text-2xl text-text-main">12 个</p>
 </div>
 <div className="bg-surface-1 p-6 rounded-2xl border border-border-default">
 <p className="text-[11px] text-text-tertiary uppercase mb-1">当前并发任务数</p>
 ...
 <p className="text-[12px] text-text-tertiary italic mt-1">成员自动通过飞书/钉钉 SSO 鉴权与流转</p>
 </div>
 ...
 <span className="px-3 py-1 bg-hover-bg rounded-lg text-[11px] text-text-secondary">{user.role}</span>
 <span className="ml-4 text-[12px] text-text-tertiary">{user.dept}</span>
 </div>
 <div className="flex items-center gap-3">
 <button className="text-[12px] text-brand-logo hover:underline">编辑权限</button>
