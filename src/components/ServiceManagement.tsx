...
export const ServiceManagement: React.FC<ServiceManagementProps> = ({ 
 ...
 <div className="w-10 h-10 bg-primary-50 rounded-xl flex items-center justify-center text-primary-500 text-xs">
 {selectedMerchant.name[0]?.toUpperCase()}
 </div>
 <div>
 <div className="flex items-center gap-3">
 <h1 className="text-[17px] font-semibold text-neutral-900 tracking-tight">{selectedMerchant.name}</h1>
 <span className="px-1.5 py-0.5 bg-neutral-100 text-neutral-500 text-[10px] rounded uppercase">uuid: {selectedMerchant.id}</span>
 </div>
 <p className="text-[11px] text-neutral-400 uppercase tracking-wider mt-0.5">正在管理该商家数据与资产</p>
 </div>
 </div>
 </div>
 ...
 className={`px-4 py-2 rounded-xl text-[13px] transition-all ${detailTab === tab.id ? 'bg-neutral-900 text-white shadow-lg' : 'text-neutral-400 hover:text-neutral-600'}`}
 >
 {tab.name}
 </button>
 ))}
 ...
 <h1 className="text-[18px] font-semibold text-neutral-900 tracking-tight">管理中心</h1>
 </div>
 
 <nav className="flex items-center gap-8">
 <button 
 onClick={() => setActiveTab('merchants')}
 className={`text-[15px] relative py-7 transition-all ${activeTab === 'merchants' ? 'text-neutral-900' : 'text-neutral-400 hover:text-neutral-600'}`}
 >
 商家管理
 ...
 className={`text-[15px] relative py-7 transition-all ${activeTab === 'team' ? 'text-neutral-900' : 'text-neutral-400 hover:text-neutral-600'}`}
 >
 组织管理
 ...
 <button className="w-full mt-4 py-2 text-[12px] text-primary-500 hover:bg-primary-50 rounded-lg transition-colors border border-primary-50 flex items-center justify-center gap-2">
 <Download size={14} /> 保存商家码
 </button>
 </div>
 <div className="flex-1 w-full space-y-6">
 <div>
 <label className="text-[11px] text-neutral-400 uppercase tracking-widest block mb-1.5">入驻短链</label>
 ...
 <button className="px-5 bg-neutral-900 text-white rounded-xl text-[13px] hover:bg-primary-500 transition-all flex items-center gap-2 shrink-0">
 ...
 <span className="text-[12px] text-white/60 text-left">活跃商家</span>
 <span className="text-[24px] ">42</span>
 </div>
 <div className="flex justify-between items-end border-b border-white/10 pb-4">
 <span className="text-[12px] text-white/60 text-left">积分消耗</span>
 <span className="text-[24px] ">12.5k</span>
 </div>
 </div>
 </div>
 <button className="w-full mt-8 py-3.5 bg-white text-neutral-900 rounded-2xl text-[13px] flex items-center justify-center gap-2 hover:bg-primary-50 transition-all shadow-xl">
 ...
 <div className="flex items-center gap-4">
 <h2 className="text-[18px] font-semibold text-neutral-900 tracking-tight">所有下线商家</h2>
 <div className="px-2 py-0.5 bg-neutral-100 rounded-lg text-[11px] text-neutral-500">活跃使用 / 活跃商家</div>
 </div>
 <div className="flex items-center gap-3">
 ...
 <thead>
 <tr className="bg-neutral-50/50 text-[10px] text-neutral-400 uppercase tracking-widest border-b border-neutral-100">
 ...
 <div className="flex items-center gap-3">
 <div className="w-9 h-9 bg-neutral-100 rounded-xl flex items-center justify-center text-neutral-500">商</div>
 <span className="text-[14px] text-neutral-900">{m.name}</span>
 </div>
 </td>
 <td className="px-8 py-5">
 <div className="flex flex-col gap-0.5">
 <span className="text-[13px] text-neutral-700">{m.email}</span>
 <span className="text-[11px] text-neutral-400 ">{m.phone}</span>
 </div>
 </td>
 <td className="px-8 py-5">
 ...
 <p className="text-[10px] text-neutral-400 uppercase">当前余额</p>
 <p className="text-[13px] text-neutral-800">5,420</p>
 </div>
 <div className="w-px h-6 bg-neutral-100" />
 <div className="text-center">
 <p className="text-[10px] text-neutral-400 uppercase">爆文数</p>
 <p className="text-[13px] text-neutral-800">82</p>
 </div>
 </div>
 </td>
 <td className="px-8 py-5 text-right">
 <button onClick={() => onSelectMerchant(m)} className="text-[13px] text-primary-500 hover:bg-primary-50 px-4 py-2 rounded-xl transition-all">进入管理 &rarr;</button>
 </td>
 </tr>
 ))}
 </tbody>
 ...
 <p className="text-[11px] text-neutral-400 uppercase mb-1">团队成员</p>
 <p className="text-2xl text-neutral-900">18 <span className="text-[12px] text-neutral-300">/ 无限制</span></p>
 </div>
 <div className="bg-white p-6 rounded-3xl border border-neutral-200">
 <p className="text-[11px] text-neutral-400 uppercase mb-1">飞书账号映射</p>
 <p className="text-2xl text-neutral-900">12 个</p>
 </div>
 <div className="bg-white p-6 rounded-3xl border border-neutral-200">
 <p className="text-[11px] text-neutral-400 uppercase mb-1">当前并发任务数</p>
 <p className="text-2xl text-primary-500">5 / 20</p>
 </div>
 </div>
 ...
 <div>
 <h2 className="text-[18px] font-semibold text-neutral-900 tracking-tight">组织成员与权限</h2>
 <p className="text-[12px] text-neutral-400 italic mt-1">成员自动通过飞书/钉钉 SSO 鉴权与流转</p>
 </div>
 <button className="px-6 py-3 bg-neutral-900 text-white rounded-xl text-[13px] shadow-lg flex items-center gap-2">
 ...
 <div className="flex items-center gap-4">
 <div className="w-10 h-10 bg-neutral-100 rounded-full flex items-center justify-center text-neutral-500">{user.name[0]}</div>
 <div>
 <h4 className="text-[14px] font-semibold text-neutral-900">{user.name}</h4>
 <p className="text-[11px] text-neutral-400 ">{user.email}</p>
 </div>
 </div>
 <div className="flex-1 px-12">
 <span className="px-3 py-1 bg-neutral-100 rounded-lg text-[11px] text-neutral-600">{user.role}</span>
 <span className="ml-4 text-[12px] text-neutral-400">{user.dept}</span>
 </div>
 <div className="flex items-center gap-3">
 <button className="text-[12px] text-primary-500 hover:underline">编辑权限</button>
 <button className="text-[12px] text-neutral-300">禁用</button>
 </div>
 </div>
 ))}
 </div>
