  ...
  return (
    ...
    >
      <div className="p-3 border-b border-neutral-100 flex items-center justify-between bg-neutral-50/50 shrink-0">
        <h3 className="text-[12px] font-black text-neutral-900 ml-1">切换执行模型</h3>
      ...
      <div className="p-2 border-t border-neutral-100 bg-neutral-50/50">
         <button 
           ...
           className="w-full py-2.5 rounded-xl text-[12px] font-black text-neutral-500 hover:text-neutral-900 hover:bg-neutral-200/50 transition-colors flex items-center justify-center gap-2"
          >
