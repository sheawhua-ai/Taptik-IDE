   ...
   return (
      <div className="flex flex-col h-full space-y-6">
         <div className="flex justify-end mb-2">
            <div className="px-4 py-1.5 bg-slate-100 rounded-full text-[12px] font-bold text-slate-600 border border-slate-200/50 shadow-sm">
               安全能力由本地运行时提供
            </div>
         </div>
            ...
            <div className="border border-slate-200 rounded-2xl bg-white overflow-hidden shadow-sm flex flex-col relative z-0">
               <div className="p-5 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                     ...
                     <span className="text-[15px] font-black text-slate-900">沙箱安全</span>
                  </div>
                  <div className="flex items-center gap-3">
                     <span className="w-5 h-5 rounded-full border border-slate-200 flex items-center justify-center text-[12px] text-slate-400 font-bold bg-white">?</span>
                     <button 
                  ...
                  <div className="space-y-4">
                     <button className="w-full flex items-center justify-between py-2 group">
                        <div className="flex gap-4">
                           ...
                           <div className="text-left py-0.5">
                              <div className="text-[14px] font-bold text-slate-800 mb-0.5">文件安全</div>
                     ...
                     <button className="w-full flex items-center justify-between py-2 group">
                        <div className="flex gap-4">
                           ...
                           <div className="text-left py-0.5">
                              <div className="text-[14px] font-bold text-slate-800 mb-0.5">命令安全</div>
                     ...
                     <button className="w-full flex items-center justify-between py-2 group">
                        <div className="flex gap-4">
                           ...
                           <div className="text-left py-0.5">
                              <div className="text-[14px] font-bold text-slate-800 mb-0.5">网络安全</div>
            ...
            <div className="border border-slate-200 rounded-2xl bg-[#f8fafc] overflow-hidden shadow-sm flex flex-col relative z-0">
               <div className="p-5 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                     ...
                     <span className="text-[15px] font-black text-slate-900">数据安全</span>
                  </div>
               </div>
               <div className="flex-1 p-5 pt-0 space-y-6">
                  ...
                  <div className="space-y-4">
                     <div className="bg-white border border-slate-200 rounded-xl p-4 flex items-start gap-4">
                        ...
                        <div className="flex-1">
                           <div className="flex items-center justify-between mb-1">
                              <span className="text-[14px] font-bold text-slate-800">安全网关</span>
                              <span className="px-2 py-0.5 bg-emerald-50 text-emerald-600 rounded text-[11px] font-bold border border-emerald-100">已开启</span>
                           </div>
                     ...
                     <div className="bg-white border border-slate-200 rounded-xl p-4 flex items-start gap-4">
                        ...
                        <div className="flex-1">
                           <div className="flex items-center justify-between mb-1">
                              <span className="text-[14px] font-bold text-slate-800">传输加密</span>
                              <span className="px-2 py-0.5 bg-emerald-50 text-emerald-600 rounded text-[11px] font-bold border border-emerald-100">已开启</span>
                           </div>
         ...
         <div className="border flex items-center justify-between border-slate-200 rounded-2xl bg-white p-5 shadow-sm">
            <div className="flex items-center gap-4">
               ...
               <div>
                  <h4 className="text-[15px] font-black text-slate-900 mb-1">系统级工具</h4>
                  <p className="text-[12px] text-slate-500">WSL、wmic、sc、reg、schtasks 等系统级工具可绕过沙箱限制，请谨慎启用</p>
               </div>
            </div>
            <select className="border border-slate-200 bg-white px-4 py-2 rounded-lg text-[13px] font-bold text-slate-700 outline-none focus:border-primary-500 shadow-sm cursor-pointer min-w-[100px]">
               <option>禁用</option>
               <option>启用</option>
            </select>
         </div>
         ...
         <div className="border border-slate-200 rounded-2xl bg-white shadow-sm overflow-hidden">
            <div className="p-5 flex items-center justify-between border-b border-slate-100">
               <div className="flex items-center gap-3">
                  ...
                  <div>
                     <h4 className="text-[15px] font-black text-slate-900 mb-0.5">内置运行时</h4>
            ...
            <table className="w-full text-left text-[13px]">
               <thead className="bg-slate-50 text-slate-500 text-[12px]">
                  <tr>
                     <th className="font-bold py-3 px-6 w-1/4">工具</th>
                     <th className="font-bold py-3 px-6 w-1/2">说明</th>
                     <th className="font-bold py-3 px-6 text-right">状态</th>
                  </tr>
               </thead>
