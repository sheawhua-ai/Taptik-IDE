...
export const AccountSettings = () => {
 ...
 <div className="w-14 h-14 bg-btn-main text-white rounded-full flex items-center justify-center text-xl ">
 1
 </div>
 <div>
 <h3 className="text-[18px] font-semibold text-text-main tracking-tight">18616306063</h3>
 <p className="text-[13px] text-text-tertiary mt-0.5">18616306063</p>
 </div>
 </div>

 <div>
 <button className="px-4 py-2 bg-surface-1 border border-border-default text-text-secondary rounded-lg text-[13px] hover:bg-page-bg transition-colors shadow-sm">
 退出登录
 </button>
 </div>
 ...
 <div className="flex items-center justify-between mb-6 relative z-10 border-b border-border-default/60 pb-6">
