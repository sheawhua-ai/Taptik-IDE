      ...
      <div className="flex flex-col h-full space-y-8">
         ...
         <div className="space-y-4">
            <div className="flex items-center justify-between">
               <div>
                  <h4 className="text-[16px] font-black text-slate-900">生成对话记忆</h4>
            ...
            <div className="w-full bg-white border border-slate-200 rounded-xl p-4 flex items-start gap-4">
               ...
               <div className="shrink-0 text-right">
                  <div className="text-[14px] font-black text-slate-900">来自对话的记忆</div>
         ...
         <div className="flex items-center justify-between">
            <div>
               <h4 className="text-[16px] font-black text-slate-900">从其他AI导入记忆</h4>
               <p className="text-[13px] text-slate-500 mt-1">一键同步你在其他AI上的使用习惯。</p>
            </div>
            <button 
               onClick={() => setIsImportModalOpen(true)}
               className="px-5 py-2 hover:bg-slate-50 text-slate-700 text-[13px] font-bold rounded-lg transition-colors"
            >
               导入
            </button>
         </div>
               ...
               <div className="fixed inset-0 z-[1100] flex items-center justify-center p-4">
                  ...
                  >
                     <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-neutral-100 relative z-10">
                        <h2 className="text-[18px] font-black text-slate-900 tracking-tight">将记忆导入TapTik</h2>
                        <button 
                           onClick={() => setIsImportModalOpen(false)}
                     ...
                     <div className="p-6 space-y-6 overflow-y-auto max-h-[60vh] bg-slate-50/50">
                        <div className="bg-white border text-left border-slate-200 rounded-2xl p-5 relative shadow-sm">
                           <div className="flex items-center justify-between mb-4">
                              <div className="flex items-center gap-3">
                                 <div className="w-6 h-6 rounded-full bg-slate-100 flex items-center justify-center text-[12px] font-black text-slate-600">1</div>
                                 <span className="text-[14px] font-bold text-slate-800">复制以下提示词到其他AI对话中</span>
                              </div>
                        ...
                        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm text-left relative">
                           <div className="flex items-center gap-3 mb-4">
                              <div className="w-6 h-6 rounded-full bg-slate-100 flex items-center justify-center text-[12px] font-black text-slate-600">2</div>
                              <span className="text-[14px] font-bold text-slate-800">将结果粘贴到下方，添加到TapTik记忆</span>
                           </div>
                           <textarea 
                     ...
                     <div className="px-6 py-4 border-t border-slate-100 bg-white flex justify-end gap-3 rounded-b-3xl">
                        <button 
                           onClick={() => setIsImportModalOpen(false)}
                           className="px-5 py-2 bg-white border border-slate-200 text-slate-600 rounded-xl text-[14px] font-bold hover:bg-slate-50 transition-colors"
                        >
                           取消
                        </button>
                        <button 
                           className="px-5 py-2 bg-slate-200 text-slate-400 rounded-xl text-[14px] font-bold cursor-not-allowed"
                        >
                           添加到记忆
                        </button>
                     </div>
