      ...
      <div className="flex flex-col h-full space-y-8">
         <div className="space-y-4">
            <div className="flex items-center justify-between">
               <div>
                  <h4 className="text-[16px] font-black text-slate-900">基本风格和语调</h4>
                  <p className="text-[13px] text-slate-500 mt-1">设置 AI 助手回复你的风格和语调。这不会影响 AI 助手的功能。</p>
               </div>
               <select className="border border-slate-200 bg-white px-4 py-2 rounded-lg text-[13px] font-bold text-slate-700 outline-none focus:border-primary-500 shadow-sm cursor-pointer w-32">
                  <option>默认</option>
                  <option>专业</option>
                  <option>幽默</option>
                  <option>简洁</option>
         ...
         <div className="space-y-4">
            <div className="flex items-center justify-between">
               <div>
                  <h4 className="text-[16px] font-black text-slate-900">加载过程欢迎语</h4>
         ...
         <div className="space-y-4">
            <div>
               <h4 className="text-[16px] font-black text-slate-900 mb-1">自定义指令</h4>
            ...
            <div className="flex justify-end pt-2">
               <button className="px-6 py-2.5 bg-primary-500 hover:bg-primary-600 text-white rounded-xl text-[14px] font-black transition-colors shadow-sm">
                  确认
               </button>
            </div>
         </div>
