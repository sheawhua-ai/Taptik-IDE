...
export default function TaskDispatch() {
 ...
 <div>
 <h1 className="text-[2rem] font-extrabold tracking-tight text-zinc-900 mb-2 font-semibold ">任务派发与素材审核</h1>
 <p className="text-zinc-500 max-w-2xl text-sm">统一掌管多商家、多门店的拍摄任务执行，打通“需求下发 - 素材回传 - AI预审 - 人工终审”全链路。</p>
 </div>
 <div className="flex gap-3">
 <button className="px-4 py-2 bg-white border border-zinc-200 text-zinc-700 rounded-xl text-sm hover:bg-zinc-50 transition-colors shadow-sm flex items-center gap-2">
 ...
 <h2 className="text-base font-semibold text-zinc-900 flex items-center gap-2 mb-6">
 ...
 <div>
 <label className="block text-xs text-zinc-700 mb-2">输入笔记灵感或拍摄需求</label>
 <textarea 
 ...
 className="w-full mt-3 bg-zinc-900 text-white py-2.5 rounded-xl text-xs shadow-md hover:bg-zinc-800 transition-colors flex items-center justify-center gap-2"
 >
 {isGenerating ? (
 ...
 <h3 className="text-xs font-semibold text-[#5157a7] flex items-center gap-1">
 ...
 <span className="bg-zinc-100 text-zinc-500 px-1.5 py-0.5 rounded text-[10px] mt-0.5">镜头1</span>
 <span>车辆外观全景图（需在户外自然环境，如草地/公园）</span>
 </div>
 <div className="bg-white p-2.5 rounded-lg border border-zinc-100 text-xs text-zinc-700 flex items-start gap-2 shadow-sm">
 <span className="bg-zinc-100 text-zinc-500 px-1.5 py-0.5 rounded text-[10px] mt-0.5">镜头2</span>
 <span>后备箱露营模式特写（需展示空间感，最好有露营装备）</span>
 </div>
 <div className="bg-white p-2.5 rounded-lg border border-zinc-100 text-xs text-zinc-700 flex items-start gap-2 shadow-sm">
 <span className="bg-zinc-100 text-zinc-500 px-1.5 py-0.5 rounded text-[10px] mt-0.5">镜头3</span>
 ...
 <label className="block text-xs text-zinc-700">选择目标商家与门店</label>
 ...
 <button className={`w-full py-3.5 rounded-xl text-sm shadow-lg active:scale-95 transition-all flex items-center justify-center gap-2 ${showTasks ? 'bg-[#5157a7] text-white hover:bg-[#444a99] shadow-[#5157a7]/20' : 'bg-zinc-100 text-zinc-400 cursor-not-allowed'}`}>
 ...
 <thead>
 <tr className="text-[11px] text-zinc-400 uppercase tracking-widest border-b border-zinc-100">
 <th className="pb-3 ">商家 / 门店</th>
 ...
 <td className="py-3">
 <div className="text-xs text-zinc-800">极氪智慧出行</div>
 ...
 <td className="py-3">
 <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] bg-amber-50 text-amber-600 border border-amber-100">待审核 (3/3)</span>
 </td>
 ...
 <tr className="hover:bg-zinc-50 transition-colors">
 <td className="py-3">
 <div className="text-xs text-zinc-800">JD Architecture</div>
 ...
 <td className="py-3">
 <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] bg-zinc-100 text-zinc-600 border border-zinc-200">待接单</span>
 </td>
 ...
 <div>
 <h3 className="text-sm font-semibold text-white">春季出游种草素材采集 <span className="text-xs font-normal text-zinc-400 ml-2">极氪智慧出行 - 上海万象城店</span></h3>
 ...
 <div>
 <p className="text-xs text-emerald-400">AI 预审通过</p>
 <p className="text-[10px] text-zinc-400 mt-0.5">画面清晰度达标，已识别到户外场景、露营装备及中控屏幕，符合任务需求约束。</p>
 </div>
 </div>

 <div className="flex gap-3">
 <button className="flex-1 py-2 bg-[#5157a7] text-white text-xs rounded-lg hover:bg-[#444a99] transition-colors shadow-md shadow-[#5157a7]/20">人工审核通过，推入生产线</button>
 <button className="px-4 py-2 bg-zinc-700 text-zinc-300 text-xs rounded-lg hover:bg-zinc-600 transition-colors">打回重拍</button>
 </div>
 </div>
 ...
 <div className="flex justify-between items-start mb-3">
 <div>
 <h3 className="text-sm font-semibold text-white">极简风样板间实拍 <span className="text-xs font-normal text-zinc-400 ml-2">JD Architecture - 深圳湾店</span></h3>
 ...
 <div>
 <p className="text-xs text-red-400">AI 预审未通过</p>
 <p className="text-[10px] text-zinc-400 mt-0.5">光线过暗，画面噪点较多，且未能有效突出“极简”风格的核心家具元素。</p>
 </div>
 </div>

 <div className="flex gap-3">
 <button className="flex-1 py-2 bg-zinc-700 text-zinc-300 text-xs rounded-lg hover:bg-zinc-600 transition-colors">一键打回重拍 (附带AI建议)</button>
 <button className="px-4 py-2 bg-zinc-800 border border-zinc-600 text-zinc-400 text-xs rounded-lg hover:bg-zinc-700 transition-colors">忽略警告，强制通过</button>
 </div>
 </div>
