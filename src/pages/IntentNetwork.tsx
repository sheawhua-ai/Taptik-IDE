...
export default function IntentNetwork() {
 ...
 <span className="px-2 py-0.5 bg-red-100 text-red-700 text-[13px] rounded-full">12 条待处理</span>
 </div>
 ...
 <span className="text-[13px] text-danger px-2 py-0.5 bg-red-50 rounded">高意向流失风险</span>
 <span className="text-[13px] text-zinc-400 italic">2 分钟前</span>
 </div>
 <p className="text-[13px] text-zinc-700 leading-relaxed mb-3">
 用户 @DesignMaster 咨询“价格与企业版区别”，智能 识别为核心购买意图，导购未能在 5 分钟内响应。
 </p>
 <button className="w-full text-[13px] py-1.5 bg-red-50 text-danger rounded hover:bg-red-100 transition-all">人工快速截流</button>
 </div>
 
 <div className="p-4 bg-surface-1 border border-zinc-200 rounded-xl shadow-sm group hover:border-zinc-300 transition-colors">
 <div className="flex justify-between items-start mb-2">
 <span className="text-[13px] text-amber-600 px-2 py-0.5 bg-amber-50 rounded">竞品拦截</span>
 <span className="text-[13px] text-zinc-400 italic">15 分钟前</span>
 </div>
 <p className="text-[13px] text-zinc-700 leading-relaxed mb-3">
 检测到 5 个关键词提及竞品 A。互动内容集中在“性能优劣”对比。建议注入案例研究。
 </p>
 <button className="w-full text-[13px] py-1.5 bg-zinc-50 text-zinc-600 border border-zinc-200 rounded hover:bg-zinc-100 transition-all">派发跟进任务</button>
 </div>
 </div>
 </div>
 </section>
 ...
 <button className="px-3 py-1 bg-surface-1 text-[13px] rounded-md shadow-sm text-[#5157a7]">实时处理</button>
 <button className="px-3 py-1 text-[13px] text-zinc-500 font-medium">历史回溯</button>
 </div>
 </div>
 ...
 <div className="flex items-center gap-1 text-[13px] text-zinc-800">
 ...
 <span className="text-[13px] text-zinc-800">JD Architecture</span>
 </div>
 <p className="text-[13px] text-zinc-500">“如何开通多端同步功能？目前预算 5k 左右...”</p>
 </div>
 </div>
 <div className="mt-3 flex gap-4">
 <div className="flex items-center gap-1">
 <span className="material-symbols-outlined text-[14px] text-[#5157a7]">bolt</span>
 <span className="text-[13px] text-zinc-500">转化评分: <span className=" text-zinc-800">8.4</span></span>
 </div>
 </div>
 </div>
 </div>
 ...
 <span className="text-[13px] text-[#e0e0ff] tracking-tight">优先级: 高</span>
 </div>
 <h4 className="text-[13px] font-semibold text-white">核心大客户拦截</h4>
 ...
 <span className="px-2 py-0.5 bg-orange-100 text-orange-700 text-[13px] rounded-full border border-orange-200">实时拦截中</span>
 </div>

 <div className="flex-1 overflow-y-auto custom-scrollbar space-y-4 pr-1">
 <div className="p-4 border border-orange-200 bg-orange-50/50 rounded-xl shadow-sm">
 <div className="flex justify-between items-start mb-3">
 <span className="text-[13px] text-zinc-900">客户：这款包包有黑色现货吗？</span>
 <span className="text-[13px] text-orange-600 border border-orange-200 px-2 py-0.5 rounded bg-surface-1">偏离商业意图</span>
 </div>
 <div className="text-[13px] text-zinc-600 mb-3 bg-surface-1 p-3 rounded-xl border border-zinc-100">
 <span className=" text-zinc-800">智能 回复：</span>目前黑色没有现货了哦，建议您看看其他颜色。
 </div>
 <div className="text-[13px] text-orange-700 flex items-start gap-1.5 bg-orange-100/50 p-3 rounded-xl">
 ...
 <button className="flex-1 py-2 bg-orange-500 text-white text-[13px] rounded-lg shadow-md shadow-orange-500/20 active:scale-95 transition-transform">人工接管</button>
 <button className="flex-1 py-2 bg-surface-1 border border-zinc-200 text-zinc-700 text-[13px] rounded-lg hover:bg-zinc-50 active:scale-95 transition-transform">标记为负面案例</button>
 </div>
 </div>

 <div className="p-4 border border-zinc-100 bg-surface-1 rounded-xl shadow-sm">
 <div className="flex justify-between items-start mb-3">
 <span className="text-[13px] text-zinc-900">客户：周末去店里人多吗？</span>
 <span className="text-[13px] text-green-600 border border-green-200 px-2 py-0.5 rounded bg-green-50">意图符合</span>
 </div>
 <div className="text-[13px] text-zinc-600 bg-zinc-50 p-3 rounded-xl border border-zinc-100">
