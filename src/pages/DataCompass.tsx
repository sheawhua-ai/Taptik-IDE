...
export default function DataCompass() {
 ...
 <div>
 <h2 className="text-3xl font-extrabold tracking-tight text-zinc-900 font-semibold ">数据罗盘</h2>
 ...
 <div>
 <h3 className="text-lg font-semibold text-zinc-900 tracking-tight">全域转化漏斗</h3>
 ...
 <p className="text-[10px] uppercase text-zinc-500">总曝光</p>
 <p className="text-sm text-zinc-900">1.2M</p>
 </div>
 </div>
 
 <div className="flex-1 h-[2px] bg-gradient-to-r from-zinc-200 to-[#5157a7]/40 mx-4 relative">
 <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-white px-2 text-[10px] text-zinc-500 border border-zinc-100 rounded">24.5%</div>
 </div>
 ...
 <div className="text-center">
 <p className="text-[10px] uppercase text-zinc-500">互动/点击</p>
 <p className="text-sm text-zinc-900">294K</p>
 </div>
 </div>
 
 <div className="flex-1 h-[2px] bg-gradient-to-r from-[#5157a7]/40 to-[#5157a7] mx-4 relative">
 <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-white px-2 text-[10px] text-[#5157a7] border border-[#5157a7]/20 rounded">8.2%</div>
 </div>
 ...
 <div className="text-center">
 <p className="text-[10px] uppercase text-zinc-500">最终转化</p>
 <p className="text-sm text-zinc-900">24.1K</p>
 </div>
 </div>
 </div>
 ...
 <button className="text-[11px] text-red-700 hover:underline">查看优化建议 -&gt;</button>
 </div>
 </section>
 ...
 <div>
 <h3 className="text-lg font-semibold text-zinc-900 tracking-tight mb-1">模板资产库</h3>
 ...
 <div>
 <p className="text-xs text-zinc-800">春夏穿搭闺蜜种草</p>
 <p className="text-[10px] text-zinc-500">已应用 124 次</p>
 </div>
 </div>
 <div className="text-right">
 <p className="text-xs text-emerald-600">高转化</p>
 </div>
 </div>
 <div className="flex items-center justify-between p-3 bg-zinc-50 rounded-xl border border-zinc-100">
 <div className="flex items-center gap-3">
 ...
 <div>
 <p className="text-xs text-zinc-800">探店打卡引流</p>
 <p className="text-[10px] text-zinc-500">已应用 42 次</p>
 </div>
 </div>
 <div className="text-right">
 <p className="text-xs text-amber-600">需优化</p>
 </div>
 </div>
 </div>
 <button className="w-full py-2.5 bg-zinc-900 text-white rounded-xl text-xs flex items-center justify-center gap-2 hover:bg-zinc-800 transition-colors">
 ...
 <div className="mb-6">
 <h3 className="text-lg font-semibold text-zinc-900 tracking-tight">财务概览</h3>
 <p className="text-xs text-zinc-500">本月营收与支出</p>
 </div>
 <div className="space-y-6">
 <div className="flex items-end gap-2">
 <span className="text-4xl text-zinc-900 tracking-tighter">￥42,890.00</span>
 <span className="text-[10px] text-emerald-600 mb-2 bg-emerald-50 px-1.5 py-0.5 rounded">+12.4% vs 上月</span>
 </div>
 <div className="grid grid-cols-2 gap-4">
 <div className="p-4 bg-zinc-50 rounded-xl border border-zinc-100">
 <p className="text-[10px] text-zinc-500 uppercase">累计收入</p>
 <p className="text-lg text-zinc-900">￥124.5K</p>
 </div>
 <div className="p-4 bg-zinc-50 rounded-xl border border-zinc-100">
 <p className="text-[10px] text-zinc-500 uppercase">AI 算力消耗</p>
 <p className="text-lg text-amber-600">￥3.2K</p>
 </div>
 </div>
 </div>
 </section>
 ...
 <div>
 <h3 className="text-lg font-semibold text-white tracking-tight">系统实时动态</h3>
 <div className="flex items-center gap-2 mt-1">
 <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
 <span className="text-[10px] text-zinc-400 uppercase tracking-widest">LIVE FEED</span>
 </div>
 </div>
 </div>
