...
export default function GlobalRadar() {
 ...
 <h1 className="text-[2rem] font-extrabold tracking-tight text-on-surface mb-2 font-semibold ">全局监控</h1>
 ...
 <span className="px-2 py-0.5 bg-tertiary-container text-on-tertiary-container text-[13px] rounded uppercase tracking-wider">High Risk</span>
 <span className="text-on-surface-variant text-[13px] font-medium">异常熔断警报</span>
 </div>
 ...
 <p className="text-[13px] text-on-surface-variant">延时 &gt; 15000ms • 自动熔断激活</p>
 </div>
 <button className="px-4 py-1.5 bg-zinc-950 text-white text-[13px] rounded-lg hover:bg-zinc-800 transition-colors">手动恢复</button>
 </div>
 ...
 <p className="text-[13px] text-on-surface-variant opacity-60">3200 req/s • 负载均衡预警</p>
 </div>
 ...
 <div>
 <p className="text-zinc-400 text-[13px] font-medium mb-1">算力大盘</p>
 ...
 <span className="text-5xl tracking-tighter">12.4</span>
 <span className="text-zinc-400 text-lg font-medium tracking-tight">M / min</span>
 </div>
 <div className="mt-2 flex items-center gap-1.5 text-emerald-400 text-[13px] ">
 ...
 <h3 className="text-lg font-semibold tracking-tight">全盘线索水位</h3>
 </div>
 <span className="text-[13px] text-on-surface-variant">实时同步</span>
 </div>
 ...
 <span className="text-4xl text-on-surface">142</span>
 <span className="text-[13px] text-on-surface-variant uppercase tracking-tighter">待处理线索</span>
 </div>
 </div>
 <p className="text-sm text-on-surface-variant font-medium">数据管道压力: <span className="text-on-surface ">78%</span></p>
 </div>
 </div>
 ...
 <div>
 <p className="text-[13px] text-on-surface-variant uppercase tracking-widest mb-1">系统可用性</p>
 ...
 <div>
 <p className="text-[13px] text-on-surface-variant uppercase tracking-widest mb-1">平均响应</p>
 <p className="text-xl ">42ms</p>
 </div>
 </div>
 ...
 <div>
 <p className="text-[13px] text-on-surface-variant uppercase tracking-widest mb-1">爆款拆解任务状态</p>
 ...
 <span className="text-[13px] cursor-pointer text-[#5157a7] border-b border-[#5157a7]">全部</span>
 <span className="text-[13px] cursor-pointer text-zinc-400 hover:text-zinc-600">错误</span>
 <span className="text-[13px] cursor-pointer text-zinc-400 hover:text-zinc-600">警报</span>
 </div>
 </div>
 ...
 <div className="col-span-2 text-[13px] font-medium text-on-surface-variant">14:02:41</div>
 <div className="col-span-2"><span className="px-2 py-0.5 bg-surface-container-high rounded text-[13px] ">INFO</span></div>
 ...
 <div className="grid grid-cols-12 py-4 border-b border-zinc-50 hover:bg-zinc-50/50 px-4 -mx-4 rounded-lg transition-colors cursor-pointer">
 <div className="col-span-2 text-[13px] font-medium text-on-surface-variant">13:58:12</div>
 <div className="col-span-2"><span className="px-2 py-0.5 bg-tertiary-container/20 text-tertiary rounded text-[13px] ">WARN</span></div>
 ...
 <div className="col-span-2 text-[13px] font-medium text-on-surface-variant">13:55:04</div>
 <div className="col-span-2"><span className="px-2 py-0.5 bg-surface-container-high rounded text-[13px] ">INFO</span></div>
