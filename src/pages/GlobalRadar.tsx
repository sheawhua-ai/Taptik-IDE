...
export default function GlobalRadar() {
 ...
 <span className="px-2 py-0.5 bg-tertiary-container text-on-tertiary-container text-[10px] rounded uppercase tracking-wider">High Risk</span>
 ...
 <button className="px-4 py-1.5 bg-zinc-950 text-white text-xs rounded-lg hover:bg-zinc-800 transition-colors">手动恢复</button>
 </div>
 ...
 <span className="text-xs text-on-surface-variant">实时同步</span>
 </div>
 ...
 <span className="text-[10px] text-on-surface-variant uppercase tracking-tighter">待处理线索</span>
 </div>
 </div>
 ...
 <div>
 <p className="text-[10px] text-on-surface-variant uppercase tracking-widest mb-1">系统可用性</p>
 ...
 <div>
 <p className="text-[10px] text-on-surface-variant uppercase tracking-widest mb-1">平均响应</p>
 ...
 <div>
 <p className="text-[10px] text-on-surface-variant uppercase tracking-widest mb-1">爆款拆解任务状态</p>
 ...
 <span className="text-xs cursor-pointer text-[#5157a7] border-b border-[#5157a7]">全部</span>
 <span className="text-xs cursor-pointer text-zinc-400 hover:text-zinc-600">错误</span>
 <span className="text-xs cursor-pointer text-zinc-400 hover:text-zinc-600">警报</span>
 </div>
 </div>
 ...
 <div className="col-span-2"><span className="px-2 py-0.5 bg-surface-container-high rounded text-[10px] ">INFO</span></div>
 ...
 <div className="col-span-2"><span className="px-2 py-0.5 bg-tertiary-container/20 text-tertiary rounded text-[10px] ">WARN</span></div>
