          ...
          <div className="max-w-5xl mx-auto space-y-6 pb-20">
             ...
             <div className="grid grid-cols-2 gap-6">
                ...
                <div className="bg-white border border-neutral-200 rounded-2xl overflow-hidden shadow-sm">
                   <div className="p-3 border-b border-neutral-100 flex items-center justify-between bg-neutral-50">
                      <div className="flex items-center gap-2">
                        <span className="text-[11px] bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded">真实体验领取</span>
                   ...
                   <div className="p-4">
                      ...
                      <div className="text-center mt-3">
                        <span className="text-[10px] text-neutral-400">处理后将沉淀到「用户反馈库」并在待发布池自动装填</span>
                      </div>
                   </div>
                </div>
             </div>
